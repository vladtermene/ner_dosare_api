...
class MyCollator(object):
    ...
    def __call__(self, input_batch):
        ...
        """
        batch_input_ids: id-ul tokenurilor (resultat din tokenizator)
        batch_labels: label-urile sub forma de cifre (0 - 30)
        batch_attention: attention masks [1-este folosit in transformator, 0-nu]
        batch_token_idx: indexul tokenului in propozitie
        """
        # max_len = 0
...
"""
token: token ca si text (practic cuvantul in sine, !poate sa fie doar o sintagma); tokenii care incep cu "##" fac parte din cuvantul precedent
token_id: Prob id-ul rezultat dupa tokenizare
tag: 'O', 'B-LOC', 'I-LOC'
tag_id: 0, 1, 2, 3, ..., 29
"""