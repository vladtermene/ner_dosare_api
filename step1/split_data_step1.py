...
with open('dosare/export_step1.json') as file_json:
    ...
    with open('data/train_step1.json', 'w') as outfile:
        json.dump(dataset['train'], outfile)
    with open('data/valid_step1.json', 'w') as outfile:
        json.dump(dataset['valid'], outfile)
    with open('data/test_step1.json', 'w') as outfile:
